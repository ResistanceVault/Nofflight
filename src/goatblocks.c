...
static char *g_pTxt[] = {
    "You have just watched Nofflight", "",
    "A demo by Ozzyboshi presented at ",
    "Flashparty 2021",
    "",
    "This demo is my little tribute",
    "to Fairlight / Noice / Offence",
    "",
    "All effects were recreated and tweaked ",
    ...
    "C64 demo",
    "",
    "The radial circle was based on the",
    "same effect by Chillobits demo",
    "(Revision 2020 Amiga compo winner)",
    "",
    "CREDITS",
    "- Dr Procton for the valkyrie image",
    "- Z3k for the my vampira image ",
    ...
    " questions (SnC,4Play)",
    "- Last but not least the whole Flashparty",
    " team and audience",
    "",
